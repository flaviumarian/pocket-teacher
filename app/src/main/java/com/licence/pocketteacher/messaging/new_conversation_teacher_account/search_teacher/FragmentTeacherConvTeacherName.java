package com.licence.pocketteacher.messaging.new_conversation_teacher_account.search_teacher;
...
public class FragmentTeacherConvTeacherName extends Fragment {
    ...
    private void setListeners() {
        ...
        teachersStartConversationRecyclerAdapter = new TeachersStartConversationRecyclerAdapter(emptyTeachers, view.getContext(), MainPageT.teacher.getUsername(), 1);
        ...
        subjectTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragmentTeacherConvTeacherSubject();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
        ...
        domainTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragmentTeacherConvTeacherDomain();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
        ...
        universityTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragmentTeacherConvTeacherUniversity();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
    ...
    private void filter(String text) {
        ...
        if (!text.equals("No text")) {
            for (Teacher teacher : FragmentTeacherConvLandingPage.allTeachers) {
