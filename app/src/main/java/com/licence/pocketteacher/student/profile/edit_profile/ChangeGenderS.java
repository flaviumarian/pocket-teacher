...
public class ChangeGenderS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_gender_s);
    ...
    private void initiateComponents(){
        ...
        // String
        currentGender = MainPageS.student.getGender();
    ...
    public void onBackPressed() {
        ...
        if(!currentGender.equals(newGender)){
            MainPageS.student.setGender(newGender);
            HelpingFunctions.setGenderBasedOnUsername(MainPageS.student.getUsername(), newGender);
        }
