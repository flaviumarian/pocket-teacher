...
public class FragmentFollowingDomainPage extends Fragment {

    private View view;
    private EditText searchET;
    private Button cancelBttn;
    private TextView nameTV, subjectTV, universityTV;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_following_domain_page, container, false);
    ...
    private void setListeners(){
        ...
        subjectTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragmentFollowingSubjectPage();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
