...
public class FragmentBlockedNamePage extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_blocked_name_page, container, false);
    ...
    private void setListeners() {
        ...
        universityTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragmentBlockedUniversityPage();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
