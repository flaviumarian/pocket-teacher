...
public class FragmentFollowersNamePage extends Fragment {
    ...
    private void setListeners() {
        ...
        cancelBttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment newFragment = new FragmentFollowersLandingPage();
        ...
        studentsRecyclerAdapter = new StudentsRecyclerAdapter(emptyStudents, view.getContext());
        studentsRV.setAdapter(studentsRecyclerAdapter);
        ...
        universityTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragmentFollowersUniversityPage();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
    ...
    private void filter(String text) {
        ...
        if (!text.equals("No text")) {
            for (Student student : FragmentFollowersLandingPage.followers) {
        ...
        studentsRecyclerAdapter.filterList(filteredStudents);
    }
}
