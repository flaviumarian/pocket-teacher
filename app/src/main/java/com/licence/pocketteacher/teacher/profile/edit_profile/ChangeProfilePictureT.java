...
public class ChangeProfilePictureT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_profile_picture_t);
    ...
    private void initiateComponents() {
        ...
        // String
        currentBase64Image = MainPageT.teacher.getProfileImageBase64();
    ...
    private void setListeners() {
        ...
        ChangeProfilePictureT.SelectAdapter selectAdapter = new ChangeProfilePictureT.SelectAdapter(getApplicationContext(), selectImages, names);
    ...
    public void onBackPressed() {
        ...
        if(!newBase64Image.equals(currentBase64Image)){
            ...
            MainPageT.teacher.setProfileImageBase64(newBase64Image); // in case the user gets to the profile before the thread is finished

            Thread thread = new Thread(new Runnable(){
                @Override
                public void run(){
                    if (newBase64Image.equals("")) {
                        HelpingFunctions.deleteProfileImageBasedOnUsername(MainPageT.teacher.getUsername());
                        MainPageT.teacher.setProfileImageBase64(newBase64Image);
                    }else{
                        ...
                        if (!currentBase64Image.equals(newBase64Image)) {
                            ...
                            HelpingFunctions.setProfileImageBasedOnUsername(MainPageT.teacher.getUsername(), newBase64Image, imageName);
                        }
                    }
                }
            });
